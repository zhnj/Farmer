...
import com.njdp.njdp_farmer.adpter.UAVListAdapter;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class UAVListActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, Window.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uavlist);

        //初始化参数及控件
        machineInfos = new ArrayList<>();
        ExpandableListView listView = (ExpandableListView) findViewById(R.id.expandableListViewUAV);
        View machinelist = findViewById(R.id.root_div_uav);
        ...
        initData();
        if (group.size() >= 0) {
            UAVListAdapter adapter = new UAVListAdapter(UAVListActivity.this, group, child, mListener);
            ...
            case CALL_PHONE:
                ...
                if (ContextCompat.checkSelfPermission(this,
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                        ...
                        new AlertDialog.Builder(UAVListActivity.this)
