...
public class register extends AppCompatActivity {
    ...
    public void showClick(View v) {
        ...
        register.this.text_user_password.setTransformationMethod(PasswordTransformationMethod.getInstance());
    }
    public void revealClick(View v) {
        password_reveal.setVisibility(View.GONE);
        password_show.setVisibility(View.VISIBLE);
        register.this.text_user_password.setTransformationMethod(HideReturnsTransformationMethod.getInstance());
    }
