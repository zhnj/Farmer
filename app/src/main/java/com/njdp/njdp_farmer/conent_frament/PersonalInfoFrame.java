...
import com.njdp.njdp_farmer.Edit_Password;
...
public class PersonalInfoFrame extends Fragment implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        resetPWD = (Button)view.findViewById(R.id.btn_resetPassword);
        pDialog = new ProgressDialog(getActivity());
        pDialog.setCancelable(false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_resetPassword:
                Log.e("------------->", "点击修改用户密码");
                Intent intent2 = new Intent(getActivity(), Edit_Password.class);
        ...
        public void onResponse(String response) {
            ...
            try {
                ...
                if (status == 0) {
                    ...
                    if(!imageexists && farmer.getImageUrl().contains(".png")){
                ...
                if (conn.getResponseCode() == 200) {
                    ...
                    if(!file.exists()){
                        if(AgentApplication.permission_READ_EXTERNAL_STORAGE && AgentApplication.permission_WRITE_EXTERNAL_STORAGE
                            ...
                            empty_hint(R.string.permission_STORAGE1);
                        }
                    }
